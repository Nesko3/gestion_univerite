...
public class StudentController {
	...
	@PostMapping("/ajouter")
	public StudentModel createStudent(@Valid @RequestBody StudentModel studentModel) {
		return studentService.saveStudent(studentModel);
	}
	
	@PutMapping("/{id}")
	public StudentModel updateStudent(@PathVariable int id, @Valid @RequestBody StudentModel studentModel) {
